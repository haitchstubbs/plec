 ...
 * context, and ref attachment. Captures are expression ids, never JS closures. */
export const CompiledActionSchema = z.object({ id: z.string(), parameters: z.array(z.string()).default([]), captures: z.array(z.string()).default([]), operations: z.array(ResourceOperationSchema).default([]), resultExpressionId: z.string().optional() });
