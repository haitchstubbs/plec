/* @ts-self-types="./node_query_wasm.d.ts" */

import * as wasm from './node_query_wasm_bg.wasm';
import { __wbg_set_wasm } from './node_query_wasm_bg.js';
__wbg_set_wasm(wasm);
...
export {
  ...
  builder_as,
  builder_canonical_ir_hash,
  builder_clear,
  builder_clone,
  builder_columns,
  builder_compile_bundle,
  builder_conflict_target_kind,
  builder_conflict_where,
  builder_delete_from,
  builder_distinct,
  ...
  builder_union_handle,
  builder_update,
  builder_using_columns,
  builder_values,
