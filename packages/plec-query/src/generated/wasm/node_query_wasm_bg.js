...
export function builder_distinct_on_columns(handle, cols_json) {
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.builder_distinct_on_columns(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_from_subquery(handle, alias, query_json) {
  ...
  try {
    ...
    const ret = wasm.builder_from_subquery(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_from_subquery_handle(
  handle,
  alias,
  rhs_handle,
) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_from_subquery_handle(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_from_table_alias(handle, table, alias) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_from_table_alias(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_insert_select_handle(handle, rhs_handle) {
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.builder_insert_select_handle(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_join_subquery(
  handle,
  join_type,
  alias,
  query_json,
  ...
  try {
    ...
    const ret = wasm.builder_join_subquery(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_join_subquery_handle(
  handle,
  join_type,
  alias,
  rhs_handle,
  ...
  try {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.builder_join_subquery_handle(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_join_table(handle, join_type, table) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_join_table(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_join_table_alias(
  handle,
  join_type,
  table,
  alias,
  ...
  try {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.builder_join_table_alias(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_on_conflict_columns(handle, cols_json) {
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.builder_on_conflict_columns(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_on_conflict_constraint(handle, constraint) {
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.builder_on_conflict_constraint(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_order_by_column(
  handle,
  col,
  direction,
  null_order,
  ...
  try {
    ...
    var ptr3 = isLikeNone(null_order)
      ? 0
      : passStringToWasm0(
          null_order,
          wasm.__wbindgen_malloc,
    ...
    const ret = wasm.builder_order_by_column(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_returning_fragment(
  handle,
  fragment_json,
  selected_cols_json,
) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_returning_fragment(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_select_fragment(
  handle,
  fragment_json,
  selected_cols_json,
) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_select_fragment(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_with_handle(handle, name, rhs_handle) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_with_handle(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function builder_with_recursive(handle, name, query_json) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_with_recursive(
      ptr0,
      len0,
      ptr1,
      len1,
 ...
 * @returns {string}
 */
export function builder_with_recursive_handle(
  handle,
  name,
  rhs_handle,
) {
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.builder_with_recursive_handle(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function __wbg___wbindgen_bigint_get_as_i64_2c5082002e4826e2(
  arg0,
  arg1,
) {
  const v = arg1;
...
export function __wbg___wbindgen_debug_string_dd5d2d07ce9e6c57(
  arg0,
  arg1,
) {
...
export function __wbg___wbindgen_jsval_loose_eq_3a72ae764d46d944(
  arg0,
  arg1,
) {
  const ret = arg0 == arg1;
...
export function __wbg___wbindgen_number_get_7579aab02a8a620c(
  arg0,
  arg1,
) {
  const obj = arg1;
...
export function __wbg___wbindgen_string_get_914df97fcfa788f2(
  arg0,
  arg1,
) {
  const obj = arg1;
...
export function __wbg_call_7f2987183bb62793() {
...
export function __wbg_get_ed0642c4b9d31ddf() {
  return handleError(function (arg0, arg1) {
...
export function __wbg_next_b3713ec761a9dbfd() {
  return handleError(function (arg0) {
    const ret = arg0.next();
    return ret;
  }, arguments);
}
export function __wbg_prototypesetcall_3e05eb9545565046(
  arg0,
  arg1,
  arg2,
) {
