...
pub struct TypedGlobalListenerHandle {
...
impl RuntimeState {
    pub fn install_typed_global_listeners(&self) -> Result<(), JsValue> {
        let candidates = self
            .typed
            .borrow()
            .iter()
...
impl TypedListenerOwner {
    ...
    pub fn row_identity(&self) -> Option<(usize, &str, u64)> {
        match self {
            Self::Row {
                loop_index,
                row_key,
    ...
    pub fn belongs_to_row(&self, loop_index: usize, row_key: &str, generation: u64) -> bool {
        self.row_identity()
    ...
    pub fn matches_disposal(&self, owner: &TypedListenerOwner) -> bool {
        self == owner
    }
}

impl RuntimeState {
    pub fn install_typed_event_listeners(&self) -> Result<(), JsValue> {
