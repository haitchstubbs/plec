...
| wasm-runtime-472 | plec dev impact: change-impact report for protocol constants and symbols | open | P2 | feature | haitchstubbs |  |
| wasm-runtime-4iq | plec-cli: select dev/app CLI at compile time from .env.plec | closed | P2 | task | haitchstubbs |  |
| **wasm-runtime-5pm** | **Implement shared Plec application build pipeline in plec-cli** | closed | P1 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-15c | Move into `plec-cli/src/com` | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-3az | Goal | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-8gq | Clean builds | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-h9f | HTML revision | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-it3 | Shared CLI ownership | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-j9d | Browser dependency validation | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-lmq | Leave application-owned | closed | P2 | task | haitchstubbs |  |
| &nbsp;&nbsp;↳ wasm-runtime-syk | Output | closed | P2 | task | haitchstubbs |  |
...
| wasm-runtime-7g4 | plec dev CLI: workflow commands (test capture, contract, trace, provenance, doctor) | closed | P1 | feature | haitchstubbs |  |
...
| wasm-runtime-b1i | Wire the native plec-server crate into dev/build workflows and retire packages/plec-server | closed | P2 | task | haitchstubbs |  |
| wasm-runtime-b50 | Unify route matching and support nested route-chain SSR | closed | P2 | feature | haitchstubbs |  |
| wasm-runtime-buy | Remove or implement crates/plec-diagnostics stub | closed | P3 | chore | haitchstubbs |  |
...
| wasm-runtime-e7f | Move WASM test orchestration under packages/plec-e2e Playwright ownership | open | P3 | chore | haitchstubbs |  |
...
| wasm-runtime-f93 | Navigation froze location-derived component props (sidebar aria-current stuck on first-load page) | closed | P1 | bug | haitchstubbs |  |
| wasm-runtime-fe3 | Update loader success acceptance for SSR | closed | P2 | task | haitchstubbs |  |
| wasm-runtime-gca | Retire packages/plec-server TS host once the Rust host is canonical | closed | P3 | task | haitchstubbs |  |
...
| **wasm-runtime-ixk** | **Harden SSR adoption and DOM identity invariants** | closed | P1 | epic | haitchstubbs | dom-runtime, ssr |
...
| **wasm-runtime-omk** | **Security hardening for executable runtime** | closed | P1 | epic | haitchstubbs |  |
...
| wasm-runtime-pp1 | Author and enforce shared, server, and client execution ownership | closed | P2 | epic | haitchstubbs |  |
