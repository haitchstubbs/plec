...
export function ProjectPage() {
  ...
  return (
    <PageFrame>
      ...
      <p id="ssr-param" className="m-0 max-w-2xl text-lg leading-8 text-muted-foreground">
        Project route matched with path {location.pathname}.
      </p>
      {detailed ? (
        <p id="ssr-branch-open" className="m-0 max-w-2xl text-lg leading-8 text-muted-foreground">
          Project detail expanded: this branch was adopted from the server render and flipped in place.
        </p>
      ) : (
        <p id="ssr-branch-closed" className="m-0 max-w-2xl text-lg leading-8 text-muted-foreground">
